...
**Scope — the shared primitive, so all five improvement call-sites move together:** craft, repair, hunt-attack, hunt-harvest, disassemble. Crafting-only would leave hunting maxing in 43 kills, and two progression engines in one game.
...
**Rough scope:** small–moderate, ~4–6 commits. Decomp: `PolishedWorld_Skill_Progression_Decomposition.md`.
