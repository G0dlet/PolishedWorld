...
**Status:** design locked; Components A–E complete & in-game-verified on `feature/recipe-knowledge`. Component F (scroll — written one-shot transfer) next, fresh chat.
...
**Status pointer:** Component E complete (E.1 + E.2). **Component F next.**
