...
**Status:** design locked; Components A–H complete & in-game-verified on `feature/recipe-knowledge`. Component I (tunn world-loot-scroll-seed — säkerhetsventil) next, fresh chat.
