...
**Status:** design locked; Components A–G complete & in-game-verified on `feature/recipe-knowledge`. Component H (teaching — synkron transfer med samtycke) next, fresh chat.
