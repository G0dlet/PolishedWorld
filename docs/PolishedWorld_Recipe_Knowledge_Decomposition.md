...
**Status:** design locked; Components A–F complete & in-game-verified on `feature/recipe-knowledge`. Component G (book — perishable bulk transfer) next, fresh chat.
...
**Status pointer:** Component F complete (F.1–F.4). **Component G next.**
